...
use Coderjerk\Dropbox\Http\Clients\DropboxHttpClientInterface;
...
class DropboxClient
{
     ...
     *
     * @var \Coderjerk\Dropbox\Http\Clients\DropboxHttpClientInterface
     */
     ...
     * Get the HTTP Client
     *
     * @return \Coderjerk\Dropbox\Http\Clients\DropboxHttpClientInterface $httpClient
     */
     ...
     * Set the HTTP Client
     *
     * @param \Coderjerk\Dropbox\Http\Clients\DropboxHttpClientInterface $httpClient
     *
     ...
     *
     * @param  \Coderjerk\Dropbox\DropboxRequest $request
     *
