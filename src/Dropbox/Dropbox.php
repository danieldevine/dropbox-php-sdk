...
namespace Coderjerk\Dropbox;

use Coderjerk\Dropbox\Models\DeletedMetadata;
use Coderjerk\Dropbox\Models\File;
use Coderjerk\Dropbox\Models\Account;
use Coderjerk\Dropbox\Models\Thumbnail;
use Coderjerk\Dropbox\Models\AccountList;
use Coderjerk\Dropbox\Models\ModelFactory;
use Coderjerk\Dropbox\Models\FileMetadata;
use Coderjerk\Dropbox\Models\CopyReference;
use Coderjerk\Dropbox\Models\FolderMetadata;
use Coderjerk\Dropbox\Models\ModelCollection;
use Coderjerk\Dropbox\Authentication\OAuth2Client;
use Coderjerk\Dropbox\Store\PersistentDataStoreFactory;
use Coderjerk\Dropbox\Authentication\DropboxAuthHelper;
use Coderjerk\Dropbox\Exceptions\DropboxClientException;
use Coderjerk\Dropbox\Security\RandomStringGeneratorFactory;
use Coderjerk\Dropbox\Http\Clients\DropboxHttpClientFactory;
...
class Dropbox
{
     ...
     * The Dropbox App
     *
     * @var \Coderjerk\Dropbox\DropboxApp
     */
    protected $app;
     ...
     * Dropbox Client
     *
     * @var \Coderjerk\Dropbox\DropboxClient
     */
    protected $client;
     ...
     * OAuth2 Client
     *
     * @var \Coderjerk\Dropbox\Authentication\OAuth2Client
     */
     ...
     *
     * @var \Coderjerk\Dropbox\Security\RandomStringGeneratorInterface
     */
     ...
     *
     * @var \Coderjerk\Dropbox\Store\PersistentDataStoreInterface
     */
     ...
     *
     * @param \Coderjerk\Dropbox\DropboxApp
     ...
     *
     * @return \Coderjerk\Dropbox\Authentication\DropboxAuthHelper
     */
     ...
     * Get OAuth2Client
     *
     * @return \Coderjerk\Dropbox\Authentication\OAuth2Client
     */
     ...
     * Get the Dropbox App.
     *
     * @return \Coderjerk\Dropbox\DropboxApp Dropbox App
     */
     ...
     * Get the Client
     *
     * @return \Coderjerk\Dropbox\DropboxClient
     */
     ...
     *
     * @return \Coderjerk\Dropbox\Models\FileMetadata | \Coderjerk\Dropbox\Models\FolderMetadata
     ...
     *
     * @return \Coderjerk\Dropbox\DropboxResponse
     */
     ...
     *
     * @return \Coderjerk\Dropbox\Dropbox Dropbox Client
     */
     ...
     *
     * @return \Coderjerk\Dropbox\Models\ModelInterface
     *
     * @throws \Coderjerk\Dropbox\Exceptions\DropboxClientException
     */
     ...
     *
     * @return \Coderjerk\Dropbox\Models\MetadataCollection
     */
     ...
     *
     * @return \Coderjerk\Dropbox\Models\ModelCollection
     */
    public function listRevisions($path, array $params = [])
    {
        ...
        //them as \Coderjerk\Dropbox\Models\FileMetadata manually.
        $body = $response->getDecodedBody();
     ...
     *
     * @return \Coderjerk\Dropbox\Models\SearchResults
     */
     ...
     *
     * @return \Coderjerk\Dropbox\Models\FolderMetadata
     *
     * @throws \Coderjerk\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \Coderjerk\Dropbox\Models\DeletedMetadata
     *
     * @throws \Coderjerk\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \Coderjerk\Dropbox\Models\DeletedMetadata|\Coderjerk\Dropbox\Models\FileMetadata
     *
     * @throws \Coderjerk\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \Coderjerk\Dropbox\Models\DeletedMetadata|\Coderjerk\Dropbox\Models\FileMetadata|\Coderjerk\Dropbox\Models\FolderMetadata
     *
     * @throws \Coderjerk\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \Coderjerk\Dropbox\Models\CopyReference
     *
     * @throws \Coderjerk\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \Coderjerk\Dropbox\Models\TemporaryLink
     *
     * @throws \Coderjerk\Dropbox\Exceptions\DropboxClientException
     */
     ...
     * @param $asyncJobId
     *
     * @return \Coderjerk\Dropbox\Models\FileMetadata|string Status (failed|in_progress) or FileMetadata (if complete)
     *
     * @throws \Coderjerk\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \Coderjerk\Dropbox\DropboxFile
     */
     ...
     *
     * @return \Coderjerk\Dropbox\Models\Thumbnail
     *
     * @throws \Coderjerk\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \Coderjerk\Dropbox\Models\File
     *
     * @throws \Coderjerk\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \Coderjerk\Dropbox\Models\Account
     */
     ...
     *
     * @return \Coderjerk\Dropbox\Models\AccountList
     */
