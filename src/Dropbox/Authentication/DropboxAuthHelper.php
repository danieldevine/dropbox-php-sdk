...
namespace Coderjerk\Dropbox\Authentication;

use Coderjerk\Dropbox\Models\AccessToken;
use Coderjerk\Dropbox\Exceptions\DropboxClientException;
use Coderjerk\Dropbox\Store\PersistentDataStoreInterface;
use Coderjerk\Dropbox\Security\RandomStringGeneratorInterface;
...
class DropboxAuthHelper
{
     ...
     *
     * @param \Coderjerk\Dropbox\Authentication\OAuth2Client             $oAuth2Client
     * @param \Coderjerk\Dropbox\Security\RandomStringGeneratorInterface $randomStringGenerator
     * @param \Coderjerk\Dropbox\Store\PersistentDataStoreInterface      $persistentDataStore
     */
     ...
     *
     * @return \Coderjerk\Dropbox\Models\AccessToken
     */
