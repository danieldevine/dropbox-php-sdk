...
use Coderjerk\Dropbox\DropboxApp;
use Coderjerk\Dropbox\DropboxClient;
use Coderjerk\Dropbox\DropboxRequest;
...
class OAuth2Client
{
     ...
     *
     * @param \Coderjerk\Dropbox\DropboxApp $app
     * @param \Coderjerk\Dropbox\DropboxClient $client
     * @param \Coderjerk\Dropbox\Security\RandomStringGeneratorInterface $randStrGenerator
     */
     ...
     * Get the Dropbox App
     *
     * @return \Coderjerk\Dropbox\DropboxApp
     */
